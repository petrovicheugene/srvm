...
#include <QVBoxLayout>
//======================================================================
X_SpectrumTableDelegate::X_SpectrumTableDelegate(QObject *parent) : QStyledItemDelegate(parent)
{
    xv_plot = new X_PrimitivePlot();
    xv_preventMouseReleaseHandle = false;
}
//======================================================================
X_SpectrumTableDelegate::~X_SpectrumTableDelegate()
{
    delete xv_plot;
}
//======================================================================
void X_SpectrumTableDelegate::paint(QPainter *painter,
...
//======================================================================
QSize X_SpectrumTableDelegate::sizeHint(const QStyleOptionViewItem &option,
                                       const QModelIndex &index) const
{
    return QStyledItemDelegate::sizeHint(option, index);
}
//======================================================================
bool X_SpectrumTableDelegate::editorEvent(QEvent *event,
...
//======================================================================
bool X_SpectrumTableDelegate::eventFilter(QObject *object, QEvent *event)
{
