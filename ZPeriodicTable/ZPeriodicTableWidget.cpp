...
#include <QVBoxLayout>
//======================================================
ZPeriodicTableWidget::ZPeriodicTableWidget(QWidget *parent) : QWidget(parent)
{
    zv_model = nullptr;
    zh_createComponents();
...
void ZPeriodicTableWidget::zh_createComponents()
{
    ...
    for (int row = 0; row < 10; row++)
    {
        ...
        for (int col = 0; col < 18; col++)
        {
            ...
            {
                zv_elementButtonList.insert(static_cast<int>(currentZNumber - 1),
...
void ZPeriodicTableWidget::zh_createConnections()
{
    ...
    {
        connect(button,
                &ZChemicalElementButton::zg_symbolChanged,
                this,
                &ZPeriodicTableWidget::zh_recalcAndApplyMinButtonSize);
        connect(button,
                &ZChemicalElementButton::toggled,
                this,
                &ZPeriodicTableWidget::zh_onButtonToggle);
    }
}
//======================================================
...
void ZPeriodicTableWidget::zp_setModel(QAbstractItemModel *model)
{
    ...
    if (zv_model != nullptr)
    {
        disconnect(model,
                   ...
                   this,
                   &ZPeriodicTableWidget::zh_updatePeriodicTable);
    }
    ...
    connect(model,
            ...
            this,
            &ZPeriodicTableWidget::zh_updateButtonCaptions);
...
void ZPeriodicTableWidget::zh_updatePeriodicTable()
{
    ...
    for (int row = 0; row < zv_elementButtonList.count(); row++)
    {
        ...
        toolTipString = QString("%1 - %2").arg(QString::number(
                                                   zv_elementButtonList[row]->zp_zNumber()),
                                               zv_elementButtonList[row]->zp_chemicalElementName());
...
//======================================================
bool ZPeriodicTableWidget::zh_setChemicalElementSymbol(ZNumber zNumber, const QString &symbol)
{
...
//======================================================
bool ZPeriodicTableWidget::zh_buttonForZNumber(ZNumber zNumber, ZChemicalElementButton *&button)
{
