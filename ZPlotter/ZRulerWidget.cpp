...
//=========================================================
void ZRulerWidget::zp_setLeftMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
...
//=========================================================
void ZRulerWidget::zp_setRightMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
...
//=========================================================
void ZRulerWidget::zp_setTopMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
...
//=========================================================
void ZRulerWidget::zp_setBottomMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
...
//=========================================================
void ZRulerWidget::zp_setHorizontalMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
    zv_topRulerProperty.K0 = K0;
    zv_topRulerProperty.K1 = K1;
    zv_topRulerProperty.K2 = K2;
...
//=========================================================
void ZRulerWidget::zp_setVerticalMarkRecalcFactors(qreal K0, qreal K1, qreal K2)
{
    zv_leftRulerProperty.K0 = K0;
    zv_leftRulerProperty.K1 = K1;
    zv_leftRulerProperty.K2 = K2;
...
void ZRulerWidget::paintEvent(QPaintEvent* event)
{
    if(zv_plot != 0 && !zv_dontRepaint)
    {
        ...
        zh_paintLeftRule1(&painter);
        zh_paintRightRule1(&painter);
        zh_paintTopRule1(&painter);
        zh_paintBottomRule1(&painter);
...
//=========================================================
void ZRulerWidget::zh_paintLeftRule1(QPainter* painter)
{
    ...
    for(int i = 0; i < zv_YRuleList->count(); i++)
    {
        ...
        if(zv_leftRulerProperty.markRect.isValid() && zv_YRuleList->value(i).markType != RulePoint::MT_SCRATCH)
        {
            ...
            {
                qreal markValue = zv_YRuleList->value(i).scenePos * -1;
                ...
                markRect.moveCenter(QPoint(zv_leftRulerProperty.markRect.right()
                                           ...
                                           - zv_leftRulerProperty.markOffset
                                           - markRect.width()/2, y));
...
//=========================================================
void ZRulerWidget::zh_paintRightRule1(QPainter* painter)
{
        ...
        if(zv_rightRulerProperty.markRect.isValid() && zv_YRuleList->value(i).markType != RulePoint::MT_SCRATCH)
        {
            ...
            if(zv_YRuleList->value(i).markType == RulePoint::MT_MARK)
            {
                ...
                markRect.moveCenter(QPoint(zv_rightRulerProperty.markRect.left()
                                           ...
                                           + zv_rightRulerProperty.markOffset
                                           + markRect.width()/2, y));
                painter->drawText(markRect, mark);
            }
        }
...
//=========================================================
void ZRulerWidget::zh_paintTopRule1(QPainter* painter)
{
    ...
    for(int i = 0; i < zv_XRuleList->count(); i++)
    {
        ...
        if(zv_topRulerProperty.markRect.isValid() && zv_XRuleList->value(i).markType != RulePoint::MT_SCRATCH)
        {
            ...
            {
                qreal markValue = zv_XRuleList->value(i).scenePos;
                ...
                markRect.moveCenter(QPoint(x, zv_topRulerProperty.markRect.bottom()
                                           ...
                                           - zv_topRulerProperty.markOffset
                                           - markRect.height()/2));
                painter->drawText(markRect, mark);
            }
        }
...
//=========================================================
void ZRulerWidget::zh_paintBottomRule1(QPainter* painter)
{
        ...
        if(zv_bottomRulerProperty.markRect.isValid() && zv_XRuleList->value(i).markType != RulePoint::MT_SCRATCH)
        {
            ...
            if(zv_XRuleList->value(i).markType == RulePoint::MT_MARK)
            {
                ...
                markRect.moveCenter(QPoint(x, zv_bottomRulerProperty.markRect.top()
                                           ...
                                           + zv_bottomRulerProperty.markOffset
                                           + markRect.height()/2));
                painter->drawText(markRect, mark);
            }
        }
...
void ZRulerWidget::zh_recalcRuleSizes()
{
    ...
    // horizontal offset
    zv_topRulerProperty.markOffset = 1;
    zv_bottomRulerProperty.markOffset = 1;

    f.setPixelSize(zv_leftRulerProperty.fontSize);
    fm = QFontMetrics(font());
    zv_leftRulerProperty.markOffset = fm.width("8");

    f.setPixelSize(zv_rightRulerProperty.fontSize);
    fm = QFontMetrics(font());
    zv_rightRulerProperty.markOffset = fm.width("8");

    // mark line sizes
    zv_topRulerProperty.markLineSize = zv_maxMarkHeight * 2;
    zv_bottomRulerProperty.markLineSize = zv_maxMarkHeight * 2;
    zv_leftRulerProperty.markLineSize = zv_maxMarkWidth + zv_leftRulerProperty.markOffset + zv_leftRulerProperty.scratchLineSize;
    zv_rightRulerProperty.markLineSize = zv_maxMarkWidth  + zv_rightRulerProperty.markOffset + zv_rightRulerProperty.scratchLineSize;
}
//=========================================================
