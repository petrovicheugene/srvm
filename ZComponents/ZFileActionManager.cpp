...
void ZFileActionManager::zp_initOpenCalibrationFromFileAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_openCalibrationFromFileAction, &QAction::trigger);
}
//======================================================
void ZFileActionManager::zp_initSaveCalibrationFromFileAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_saveCalibrationToFileAction, &QAction::trigger);
...
void ZFileActionManager::zp_initSaveAsCalibrationFromFileAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_saveCalibrationAsFileAction, &QAction::trigger);
...
void ZFileActionManager::zp_initOpenSpectrumArrayAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_openArrayFromFileAction, &QAction::trigger);
}
//======================================================
void ZFileActionManager::zp_initSaveSpectrumArrayAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_saveArrayToFileAction, &QAction::trigger);
}
//======================================================
void ZFileActionManager::zp_initSaveAsSpectrumArrayAction(QAction*& action) const
{
    ...
    connect(action, &QAction::triggered, zv_saveArrayAsFileAction, &QAction::trigger);
}
//======================================================
...
void ZFileActionManager::zh_createActions()
{
    ...
    zv_saveArrayAsFileAction = new QAction(QIcon(NS_Icons::glIconSaveAsArray),
                                           tr("Save spectrum array list &as..."),
                                           this);
    zv_saveArrayAsFileAction->setEnabled(false);

    zv_openCalibrationFromFileAction = new QAction(QIcon(NS_Icons::glIconOpenCalibration),
                                                   tr("Open &calibrations"),
                                                   this);
    zv_saveCalibrationToFileAction = new QAction(QIcon(NS_Icons::glIconSaveCalibration),
                                                 tr("Save calibration"),
                                                 this);
    zv_saveCalibrationToFileAction->setEnabled(false);
    zv_saveCalibrationAsFileAction = new QAction(QIcon(NS_Icons::glIconSaveAsCalibration),
...
//======================================================
bool ZFileActionManager::zh_getRawSpectrumArrayFromFile(const QString& fileName,
                                                        QList<ZRawSpectrumArray>& rawArray)
{
    QFileInfo fileInfo(fileName);
...
//======================================================
void ZFileActionManager::zp_saveSpectraArrayListToFile(QString& filePath,
...
//======================================================
void ZFileActionManager::zp_saveCalibrationToFile(const ZCalibration* calibration,
                                                  QString filePath,
                                                  QString name)
{
    QString absFileName;
...
void ZFileActionManager::zh_saveCalibrationProjectFile(const QString& calibrationFilePath)
{
    ...
    QString projectFilePath = dir.absoluteFilePath(fileInfo.baseName() + "." + zv_projectFileSuffix);
...
{
    QString filePath = QFileInfo(QDir(zv_calibrationFolderPath), "*." + zv_calibrationFileSuffix)
                           .absoluteFilePath();
    if (zh_defineCalibrationFileNameToSave(filePath))
    {
        emit zg_requestCalibrationDataAndInitSaving(QFileInfo(filePath).absolutePath(),
