...
//======================================================
void ZFileActionManager::zp_initOpenCalibrationFromFileAction(
    QAction*& action) const
{
    ...
    connect(action,
            &QAction::triggered,
            zv_openCalibrationFromFileAction,
            &QAction::trigger);
}
//======================================================
void ZFileActionManager::zp_initSaveCalibrationFromFileAction(
    QAction*& action) const
{
    ...
    connect(action,
            &QAction::triggered,
            zv_saveCalibrationToFileAction,
            &QAction::trigger);
    //    connect(zv_saveCalibrationToFileAction,
    //            &QAction::changed,
    //            this,
    //            &ZFileActionManager::zh_synchronizeSaveCalibrationActions);
    //    connect(this,
    //            &ZFileActionManager::zg_saveCalibrationActionEnabledChanged,
    //            action,
    //            &QAction::setEnabled);
}
//======================================================
//void ZFileActionManager::zh_synchronizeSaveCalibrationActions()
//{
...
//    emit zg_saveCalibrationActionEnabledChanged(action->isEnabled());
//}
//======================================================
void ZFileActionManager::zp_initSaveAsCalibrationFromFileAction(
    QAction*& action) const
{
    ...
    connect(action,
            &QAction::triggered,
            zv_saveCalibrationAsFileAction,
            &QAction::trigger);
    //    connect(zv_saveCalibrationAsFileAction,
    //            &QAction::changed,
    //            this,
    //            &ZFileActionManager::zh_synchronizeSaveAsCalibrationActions);
    //    connect(this,
    //            &ZFileActionManager::zg_saveCalibrationAsActionEnabledChanged,
    //            action,
    //            &QAction::setEnabled);
}
//======================================================
//void ZFileActionManager::zh_synchronizeSaveAsCalibrationActions()
//{
//    QAction* action = qobject_cast<QAction*>(sender());
//    if (!action)
//    {
...
//    emit zg_saveCalibrationAsActionEnabledChanged(action->isEnabled());
//}
//======================================================
...
{
    zv_openArrayFromFileAction = new QAction(QIcon(NS_Icons::glIconOpenArray),
                                             tr("&Open spectrum array list"),
                                             this);
    zv_saveArrayToFileAction = new QAction(QIcon(NS_Icons::glIconSaveArray),
                                           tr("&Save spectrum array list"),
                                           this);
    zv_saveArrayToFileAction->setEnabled(false);
    zv_saveArrayAsFileAction
        = new QAction(QIcon(NS_Icons::glIconSaveAsArray),
                      tr("Save spectrum array list &as..."),
                      this);
    zv_saveArrayAsFileAction->setEnabled(false);

    zv_openCalibrationFromFileAction
        = new QAction(QIcon(NS_Icons::glIconOpenCalibration),
                      tr("Open &calibrations"),
                      this);
    zv_saveCalibrationToFileAction
        = new QAction(QIcon(NS_Icons::glIconSaveCalibration),
                      tr("Save calibration"),
                      this);
    zv_saveCalibrationToFileAction->setEnabled(false);
    zv_saveCalibrationAsFileAction
        = new QAction(QIcon(NS_Icons::glIconSaveAsCalibration),
    ...
    zv_openCalibrationProjectAction
        = new QAction(QIcon(), tr("Open calibration &project"), this);
}
//======================================================
void ZFileActionManager::zh_createConnections()
{
    connect(zv_openArrayFromFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onOpenSpectrumArrayAction);
    connect(zv_saveArrayToFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onSaveSpectrumArrayAction);
    connect(zv_saveArrayAsFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onSaveSpectrumArrayAsAction);

    connect(zv_openCalibrationFromFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onOpenCalibrationAction);
    connect(zv_saveCalibrationToFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onSaveCalibrationAction);
    connect(zv_saveCalibrationAsFileAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onSaveCalibrationAsAction);

    connect(zv_openCalibrationProjectAction,
            &QAction::triggered,
            this,
            &ZFileActionManager::zh_onOpenCalibrationProjectAction);
}
//======================================================
bool ZFileActionManager::zh_defineSpectrumArrayFileNameToOpen(
    QString& fileName) const
{
    ...
    fileName = QFileDialog::getOpenFileName(
        ...
        tr("Spectrum array files(*.%1);;XML files(%2);;All files(%3)")
            .arg(zv_spectrumArrayFileSuffix, "*.xml", "*.*"));
    return zh_checkFile(fileName);
}
//======================================================
bool ZFileActionManager::zh_defineSpectrumArrayFileNameToSave(
    QString& fileName) const
{
    // opening
...
//======================================================
bool ZFileActionManager::zh_defineCalibrationFileNamesToOpen(
    QStringList& fileNames) const
{
    ...
    fileNames = ZXMLCalibrationIOHandler::zp_getCalibrationOpenFiles(
        zv_calibrationFolderPath);
...
//======================================================
bool ZFileActionManager::zh_defineCalibrationFileNameToSave(
    QString& fileName) const
{
...
//======================================================
bool ZFileActionManager::zh_getRawSpectrumArrayFromFile(
    const QString& fileName, QList<ZRawSpectrumArray>& rawArray)
{
    QFileInfo fileInfo(fileName);
    ...
    if (!fileInfo.exists() || !fileInfo.isFile())
    {
        ...
        return false;
             ...
             && fileInfo.suffix() != zv_spectrumArrayFileSuffix)
    {
        QString msg
            = tr("Error handling file \"%1\"! Cannot handle \"%2\" files.")
    ...
    connect(ioHandler,
            &ZXMLSpectrumArrayIOHandler::zg_message,
            this,
            &ZFileActionManager::zg_message);
...
void ZFileActionManager::zp_saveSettings() const
{
    ...
    settings.setValue("spectrumArrayFolderPath",
                      QVariant(zv_spectrumArrayFolderPath));
    settings.setValue("calibrationArrayFolderPath",
                      QVariant(zv_calibrationFolderPath));
...
//======================================================
void ZFileActionManager::zp_saveSpectraArrayListToFile(
    QString& filePath, QList<ZRawSpectrumArray> rawArrayList, bool& res)
{
    if (filePath.isEmpty())
    {
...
//======================================================
void ZFileActionManager::zp_saveCalibrationToFile(
    const ZCalibration* calibration, QString filePath, QString name)
{
    QString absFileName;
    if (filePath.isEmpty())
    {
        absFileName = QFileInfo(QDir(zv_calibrationFolderPath), name)
                          .absoluteFilePath();
        ;
    ...
    // ability of message receiving
    connect(&ioHandler,
            &ZXMLCalibrationIOHandler::zg_message,
            this,
            &ZFileActionManager::zg_message);
...
//======================================================
void ZFileActionManager::zh_saveCalibrationProjectFile(
    const QString& calibrationFilePath)
{
    ...
    QString projectFileName = dir.absoluteFilePath(fileInfo.baseName() + "."
                                                   + zv_projectFileSuffix);
    ...
    XMLCalibrationProjectIOHandler.zp_writeProjectData(file,
                                                       calibrationFilePath,
...
{
    QString filePath = QFileInfo(QDir(zv_calibrationFolderPath),
                                 "*." + zv_calibrationFileSuffix)
                           .absoluteFilePath();
    if (zh_defineCalibrationFileNameToSave(filePath))
    {
        emit zg_requestCalibrationDataAndInitSaving(
            QFileInfo(filePath).absolutePath(), QFileInfo(filePath).fileName());
    }
}
//======================================================
void ZFileActionManager::zh_onOpenCalibrationProjectAction()
{
    ...
    connect(&XMLCalibrationProjectIOHandler,
            &ZXMLCalibrationProjectIOHandler::zg_message,
            this,
            &ZFileActionManager::zg_message);

    if (!XMLCalibrationProjectIOHandler.zp_readProjectData(file,
                                                           calibrationFilePath,
                                                           spectrumArrayFilePath))
    ...
    emit zg_spectrumRawArrayList(spectrumArrayFilePath, rawArrayList);
