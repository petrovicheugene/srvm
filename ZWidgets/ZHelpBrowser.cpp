...
void ZHelpBrowser::zp_createComponents(const QStringList& pathList, const QUrl& doc)
{
    ...
    mv_homeAction->setIcon(QIcon(":/images/ZWidgets/green_home.ico"));

    mv_backwardAction = new QAction(this);
    mv_backwardAction->setIcon(QIcon(":/images/ZWidgets/green_left.ico"));

    mv_forwardAction = new QAction(this);
    mv_forwardAction->setIcon(QIcon(":/images/ZWidgets/green_right.ico"));
